...
<h1>Dispensador de comida</h1></head><body>
<center><h2>Configuracion wifi</h2></center>
<form action="/get">
...
<p><button class="btn" type="submit" value="Submit">Cambiar wifi</button></a>
</form>
</br><center><h2>Configuracion horario</h2></center>
<form action="/get">
<center>Inserte hora</center>
...
<p><button class="btn" type="submit" value="Submit">Guardar tomas</button></a></p>
</form>
</br><center><h2>Configuracion peso</h2></center>
<center>Introduce peso (g)</center>
<form action="/get">
<input class="inputCentered" type="text" id="peso" name="peso" required minlength="1" maxlength="2" size="4"></br>
<p><button class="btn" type="submit" value="Submit">Guardar cantidad</button></a></p>
</form>
